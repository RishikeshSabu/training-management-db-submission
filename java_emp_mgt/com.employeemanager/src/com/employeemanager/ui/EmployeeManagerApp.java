...
public class EmployeeManagerApp {
	...
	public static void main(String[] args) {
		...
		//addEmployee
		//EmployeeDTO employee=new EmployeeDTO(101, "Rahul", "John", "rahul.john@example.com", "9123456789", "Engineering", "75000", "2021-06-15");-->Duplicate Key error		//EmployeeDTO employee=null;-->null Exception
...
//		
		...
		Response<List<String>> addEmployeesInBatchResponse=controller.addEmployeesInBatch(employeeList);
		if(addEmployeesInBatchResponse.getStatusCode()==200) {
